...
namespace WebApplication1.Controllers
{
    public class ProfessionistController : Controller
    {
        ...
        private readonly DomainUoW domainUoW;

        public ProfessionistController (NoNullProjectContext context, DomainUoW domainUoW)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await domainUoW.FindAllAsync());
        }
